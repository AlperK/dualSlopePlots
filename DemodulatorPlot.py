...
p0 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('PhaseCalibration'),
...
p1 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('PhaseCalibration'),
...
p2 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('PhaseCalibration'),
...
p3 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('PhaseCalibration'),
...
a0 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('AmplitudeCalibration'), Path('1kHz_amplitude.csv'))
amp0 = []
a_vol0 = []
...
# a1 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('AmplitudeCalibration'), Path('4kHz_amplitude.csv'))
# amp1 = []
# a_vol1 = []
...
#
# a2 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('AmplitudeCalibration'), Path('7kHz_amplitude.csv'))
# amp2 = []
# a_vol2 = []
...
#
# a3 = Path.joinpath(Path('2022-05-12'), Path('Demodulator-2'), Path('AmplitudeCalibration'), Path('10kHz_amplitude.csv'))
# amp3 = []
# a_vol3 = []
